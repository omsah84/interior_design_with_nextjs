      ...
      >
        {offerings.map((offering, index) => (
          <Box
            key={index}
            sx={{
              width: { xs: '100%', sm: 'calc(50% - 16px)', md: 'calc(25% - 16px)' }, // Adjust width based on screen size
              cursor: 'pointer',
              transition: 'transform 0.3s ease-in-out',
              transform: hoverIndex === index ? 'scale(1.05)' : 'scale(1)',
              boxShadow: hoverIndex === index ? '0px 8px 16px rgba(0, 0, 0, 0.3)' : '0px 4px 8px rgba(0, 0, 0, 0.1)',
            }}
